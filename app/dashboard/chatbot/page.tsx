...
export default function ChatbotPage() {
  ...
  return (
    <div className="flex items-center w-full bg-background">
      <div
        className={cn(
          "flex flex-col justify-end w-full mx-auto max-w-3xl",
          showContent ? "h-fit" : "h-full"
        )}
      >
        {showContent ? (
          <div>
                      ...
                      if (state === "result") {
                        if (
                          ...
                          return (
                            <div
                              key={toolCallId}
                              className="font-mono text-sm bg-zinc-900 border border-zinc-800 rounded-md py-3 px-6"
                            >
